...
var api = require('./app/routes/api')(app, express, io); // we need to put app and express here because we use app, express when export api or they will be treated as local variable
